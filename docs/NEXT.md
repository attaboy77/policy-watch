...
마지막 갱신: 2026-09-02, 최근 정책동향 뉴스 필터 4종 커밋(`4a11584`) 직후 기준. **Phase 6(GitHub Pages 자동 배포) 완료·운영 중.**
현재 `site/data.json`: 150건(K-IFRS 66 / 세법 33 / 내부회계 32 / ESG 19), 일정 73건, `current_standards` 필드 포함. 테스트 441개 통과. AI 요약 캐시 43건.
